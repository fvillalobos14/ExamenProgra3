...
public:
    ...
    void setupUi(QMainWindow *Notepad)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/back"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *Notepad)
    {
        ...
        toolBar->setWindowTitle(QApplication::translate("Notepad", "Tools", 0));
    } // retranslateUi
